 ...
 *
 * `optionalAuthenticate` is the same flow but never rejects — useful for
 * endpoints whose behavior changes when the caller is logged in (e.g. the
 * `postedByMe` filter on the public job listing).
 */
